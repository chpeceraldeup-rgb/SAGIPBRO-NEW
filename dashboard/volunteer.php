        ...
        <main id="main-content" class="admin-content">
            ...
            <div class="dashboard-grid">
                ...
                <div class="dashboard-stack">
                    <section class="data-card" aria-labelledby="quick-action-title"><div class="data-card-header"><h2 id="quick-action-title">Quick actions</h2></div><div class="data-card-body d-grid gap-2"><a class="btn btn-brand justify-content-start" href="../pages/distribution/index.php"><i class="bi bi-plus-circle"></i> Record distribution</a><a class="btn btn-brand-soft justify-content-start" href="../pages/evacuation/index.php"><i class="bi bi-person-check"></i> View center occupancy</a><a class="btn btn-outline-brand justify-content-start" href="../pages/resources/index.php"><i class="bi bi-box-seam"></i> Check resource stock</a></div></section>
