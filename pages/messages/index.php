...
$messages = [];
try {
    $messages = $conn->query('SELECT id, name, email, phone, sitio, subject, message, status, created_at FROM contact_messages ORDER BY created_at DESC')->fetchAll();
} catch (Throwable $e) {
...
<div class="admin-shell">
    ...
    <div class="admin-main">
        ...
        <main class="admin-content" id="main-content">
            ...
            <section class="data-card" aria-labelledby="messagesHeading">
