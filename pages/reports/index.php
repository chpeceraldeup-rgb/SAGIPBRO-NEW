    ...
    <div class="admin-main">
        ...
        <main class="admin-content" id="main-content">
            ...
            <section class="stat-grid" aria-label="Reporting overview">
                <article class="stat-card"><div class="stat-card-top"><span class="stat-card-label">Reports generated</span><span class="stat-card-icon"><i class="bi bi-file-earmark-bar-graph-fill" aria-hidden="true"></i></span></div><strong class="stat-value">38</strong><span class="stat-meta">This month</span></article>
                <article class="stat-card info"><div class="stat-card-top"><span class="stat-card-label">Records summarized</span><span class="stat-card-icon"><i class="bi bi-database-fill-check" aria-hidden="true"></i></span></div><strong class="stat-value">2.1K</strong><span class="stat-meta">Across core modules</span></article>
                <article class="stat-card"><div class="stat-card-top"><span class="stat-card-label">Last data sync</span><span class="stat-card-icon"><i class="bi bi-arrow-repeat" aria-hidden="true"></i></span></div><strong class="stat-value">8:45</strong><span class="stat-meta">Today, Philippine time</span></article>
                <article class="stat-card warning"><div class="stat-card-top"><span class="stat-card-label">Scheduled reports</span><span class="stat-card-icon"><i class="bi bi-calendar-check-fill" aria-hidden="true"></i></span></div><strong class="stat-value">5</strong><span class="stat-meta">Next run at 5:00 PM</span></article>
            </section>
            ...
            <section class="data-card mt-3" aria-labelledby="recentReportsHeading">
                <div class="data-card-header"><div><h2 id="recentReportsHeading">Recently generated</h2><p>Ready-to-use reports prepared by authorized personnel.</p></div><span class="status-badge status-info">5 files</span></div>
                <div class="table-responsive"><table class="table app-table" id="recentReportsTable"><caption class="visually-hidden">Recently generated SAGIPBRO reports</caption><thead><tr><th scope="col">Report</th><th scope="col">Period</th><th scope="col">Generated by</th><th scope="col">Generated</th><th scope="col">Format</th><th scope="col" class="text-end">Actions</th></tr></thead><tbody>
                    <tr><td><span class="table-primary-text">Daily Distribution Summary</span><span class="table-secondary-text">RPT-2026-0910-05</span></td><td>Sep 10, 2026</td><td>Rogelio Cruz</td><td>8:31 AM</td><td><span class="status-badge status-success">CSV</span></td><td class="text-end"><button class="btn btn-light btn-icon" type="button" title="Print report" aria-label="Print Daily Distribution Summary" data-print="#recentReportsTable"><i class="bi bi-printer" aria-hidden="true"></i></button> <button class="btn btn-light btn-icon" type="button" title="Export report" aria-label="Export Daily Distribution Summary" data-export="#recentReportsTable" data-export-name="daily-distribution-summary"><i class="bi bi-download" aria-hidden="true"></i></button></td></tr>
                    <tr><td><span class="table-primary-text">Resource Stock Position</span><span class="table-secondary-text">RPT-2026-0910-04</span></td><td>Sep 10, 2026</td><td>Maria Santos</td><td>8:15 AM</td><td><span class="status-badge status-danger">PDF</span></td><td class="text-end"><button class="btn btn-light btn-icon" type="button" title="Print report" aria-label="Print Resource Stock Position" data-print="#recentReportsTable"><i class="bi bi-printer" aria-hidden="true"></i></button> <button class="btn btn-light btn-icon" type="button" title="Export report" aria-label="Export Resource Stock Position" data-export="#recentReportsTable" data-export-name="resource-stock-position"><i class="bi bi-download" aria-hidden="true"></i></button></td></tr>
                    <tr><td><span class="table-primary-text">Evacuation Occupancy Brief</span><span class="table-secondary-text">RPT-2026-0909-03</span></td><td>Sep 9, 2026</td><td>Paolo Garcia</td><td>6:50 PM</td><td><span class="status-badge status-info">XLSX</span></td><td class="text-end"><button class="btn btn-light btn-icon" type="button" title="Print report" aria-label="Print Evacuation Occupancy Brief" data-print="#recentReportsTable"><i class="bi bi-printer" aria-hidden="true"></i></button> <button class="btn btn-light btn-icon" type="button" title="Export report" aria-label="Export Evacuation Occupancy Brief" data-export="#recentReportsTable" data-export-name="evacuation-occupancy-brief"><i class="bi bi-download" aria-hidden="true"></i></button></td></tr>
                </tbody></table></div>
            </section>
        </main>
    </div>
...
<div class="modal fade" id="reportPreviewModal" tabindex="-1" aria-labelledby="reportPreviewModalLabel" aria-hidden="true"><div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable"><div class="modal-content">
    ...
    <div class="modal-body" id="reportPreviewContent">
        <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4"><div><span class="eyebrow mb-2">SAGIPBRO report</span><h3 class="h4 mb-1">Resource Stock Position</h3><p class="small mb-0">Generated September 10, 2026 at 8:45 AM PHT</p></div><span class="status-badge status-success">Verified data</span></div>
        <div class="metric-split border rounded-3 mb-4"><div><strong>428</strong><span>Total available units</span></div><div><strong>6</strong><span>Resource categories</span></div><div><strong>3</strong><span>Low-stock items</span></div></div>
